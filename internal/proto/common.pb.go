...
func (x *ServerInfoResponse) Reset() {
	*x = ServerInfoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_proto_common_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServerInfoResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_common_proto_rawDescGZIP(), []int{2}
}
...
var file_internal_proto_common_proto_rawDesc = []byte{
	...
	,
}
...
var file_internal_proto_common_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_proto_common_proto_goTypes = []interface{}{
	(*Empty)(nil),              // 0: Empty
	(*ServerInfoRequest)(nil),  // 1: ServerInfoRequest
	(*ServerInfoResponse)(nil), // 2: ServerInfoResponse
}
var file_internal_proto_common_proto_depIdxs = []int32{
	1, // 0: CFSPublic.GetServerInfo:input_type -> ServerInfoRequest
	0, // 1: CFSPublic.CreateFarm:input_type -> Empty
	2, // 2: CFSPublic.GetServerInfo:output_type -> ServerInfoResponse
	0, // 3: CFSPublic.CreateFarm:output_type -> Empty
...
func file_internal_proto_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
